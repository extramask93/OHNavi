...
// configuration step. It creates a namespace called `OHNavi`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", OHNavi::cmake::project_name, OHNavi::cmake::project_version) };
